<script lang="ts">
	...
	import { removeUserSchema, type RemoveUserSchema } from './shared';
	import { type SuperValidated, type Infer, superForm } from 'sveltekit-superforms';
	import { zodClient } from 'sveltekit-superforms/adapters';

	export let data: SuperValidated<Infer<RemoveUserSchema>>;
...
<form method="POST" class="space-y-4" use:enhance>
	<p class="font-bold">Are you sure you want to remove this user?</p>
	...
	<Form.Button>Remove User</Form.Button>
</form>
